...
namespace SZ_BydKeyboard
{
    ...
    {
        public double[] USL = new double[] { 1, 1, 1, 1, 1, 0.3, 0.3, 0.2, 0.6, 0.6, 0.2, 0.9, 0.9, 0.2, 0.9, 0.9, 0.2, 0.6, 0.6, 0.2, 0.4 };
        public double[] LSL = new double[] { 0.8, 0.8, 0.8, 0.8, 0.8, 0.1, 0.1, 0, 0.4, 0.4, 0, 0.7, 0.7, 0, 1.1, 1.1, 0, 0.4, 0.4, 0, 0.2 };


        public double[] Mult1 = new double[DataHelper.MeasureNames.Length];
        public double[] Add1 = new double[DataHelper.MeasureNames.Length];
        public double[] Mult2 = new double[DataHelper.MeasureNames.Length];
        public double[] Add2 = new double[DataHelper.MeasureNames.Length];
        public int[] NgCount = new int[] { };

        public PortParam DataReadPortParam1 = new PortParam();

        public PortParam DataReadPortParam2 = new PortParam();

        public PortParam HeightSensorPortParam = new PortParam();

        public PortParam LightControlPortParam = new PortParam();

        public PortParam IoPortParam = new PortParam();

        //位置字典
        public Dictionary<string, double> DictPos = new Dictionary<string, double>();
        //轴字典
        public Dictionary<string, int> DictAxis = new Dictionary<string, int>();
        //检测点位
        public Dictionary<string, CheckPos> DicCheck = new Dictionary<string, CheckPos>();

        public double OffsetY2toY1 = 8.0;

        public double OffsetX2toX1 = 8.0;

        public double OffsetZ2toZ1 = 8.0;

        public double OffsetAltimeterToCameraX = 0.0;
        public double OffsetAltimeterToCameraY = 0.0;
        public double OffsetAltimeterToCameraZ = 0.0;

        public double[] OffsetX = new double[] { };
        public double[] OffsetY = new double[] { };
    ...
    public class Common
    {
        public static List<int> nResultList = new List<int> { };

        public static string[] FaiNames = new string[] { };

        public static List<string> NgSnList = new List<string> { };
        ...
        public static string[] StarFais = new string[]
        {
             "Power switch",
             "Switch screw 1",
             "Power flex&Connector buckle",
             "Mesa flex&Connector buckle",
             "Mesa jumper flex cosmetic 1",
             "Mesa jumper flex cosmetic 2",
             "Mesa jumper flex cosmetic 3",
             "Mesa jumper flex cosmetic 4",
             "MLB jumper flex B2B",
        ...
        public static string[] StarFireFais = new string[]
        {
             "Power switch",
             "Switch screw 1",
             "Power flex&Connector buckle",
        ...
        public static string[] FlashFais = new string[]
        {
             "Power switch",
             "Switch screw 1",
             "Switch screw 2",
        ...
        public static List<string> str_PosList = new List<string>
        {
            "取料位1",
            "扫码位1",
            "等待位1",
        ...
        //Mes数据
        public static MesData mes = new MesData();

        //检测结果
        public bool[] ResultList = new bool[] { };

        //相机1
        public static ECamera Cam1;

        public static string str_DataCode1 = "";

        public static string str_DataCode2 = "";

        public static string str_CurrentDataCode = "";

        public static bool bSafeLightUse = true;

        public static bool bOfflineMesUse = false;

        public static int ImageIdx = 0;

        public static List<double> HeightMeasureX = new List<double> { };

        public static List<double> HeightMeasureY = new List<double> { };

        public static List<double> HeightMeasureZ = new List<double> { };

        public static SerialPort DataReadPort1 = new SerialPort();

        public static SerialPort DataReadPort2 = new SerialPort();

        public static SerialPort HeightSensorPort = new SerialPort();

        public static SerialPort LightControlPort = new SerialPort();

        public static SerialPort IoPort = new SerialPort();
        //控制类
        public static ProControl ProC = ProControl.GetInstance();
        //检测类
        public static DoCode InspectCode;
        //2D图像队列
        ...
        public static ShowMsg ShowDataCode;
        public static ShowMsg ShowProductType;
        public static ShowMsg ShowInspectTime;

        public static Stopwatch stop = new Stopwatch();


        public delegate void DelegateBool(bool bTrue);
        public static DelegateBool SetB2B;
        //设置权限
        ...
        //数据公差
        public static FrmValueLimit frmValueLimit = new FrmValueLimit();
        //检测设置
        public static FrmInspectSetting frmInspect = new FrmInspectSetting();
        //数据汇总
        public static FrmDataSum frmDataSum = new FrmDataSum();

        //主界面
        public static MainForm frmMain = new MainForm();
        //保存原图
        public static bool bSaveRawImage = true;
        ...
        public static bool OpenSerialPort(SerialPort port, PortParam param)
        {
            if (port.IsOpen)
            {
                port.Close();
            }
            port.PortName = param.PortName;
